---
title: "From Brain Chemistry to Computational Chemistry: Modeling Pronation and Solvation Effects on Major Neurotransmitters"
abstract: | 
...
dopamine, serotonin, and epinephrine ({cite}`sheffler_physiology_2026-1, pubchem_dopamine_nodate, pubchem_serotonin_nodate`).
...
All molecular calculations were performed using Gaussian ({cite}`noauthor_north_nodate, polik_<span_2022`) on the high school computational chemistry server [@noauthor_wolfram_nodate]. With the exception of serotonin, all structures were optimized and analyzed at the B3LYP/6-31G(d) level of theory [@lo_striking_2025], providing a consistent computational framework for comparing the neutral, protonated, gas-phase, and solvated forms of dopamine, serotonin, and epinephrine.
